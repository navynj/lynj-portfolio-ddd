  ...
  return (
    <section className="flex flex-col space-y-8xl max-w-3xl mx-auto">
      <Paragraph title="도전적인 UI 개발을 즐깁니다.">
        ...
        <p>
          개인 프로젝트에서 UI를 직접 기획하였으며, 개발 작업까지 실현해내어
          본인의 기획에 책임을 졌습니다. 대표적인 도전으로는 가계부 프로젝트에서의{' '}
          <a href="#skin">‘동물 스킨을 입힌 링 모양 차트 애니메이션'</a>과 타이머 플래너
          프로젝트에서의{' '}
          <a href="#time">
      ...
      <Paragraph title="사용자 경험을 최우선의 가치에 둡니다.">
        ...
        <p>
          해결하기 까다로웠음에도 불구하고 사용자 경험을 위해 방안을 모색하고 실현해냈던
          경험으로는 <a href="#overlay">‘오버레이 닫기 경험 개선 과정'</a>이 있습니다.
        </p>
      </Paragraph>
      <Paragraph title="1px을 중요하게 생각합니다.">
        ...
        <p>
          ...
          <a href="#ring-round">‘링 차트의 시작점을 둥글리는 처리’</a>를 하였으며,{' '}
          <a href="#time-round">
